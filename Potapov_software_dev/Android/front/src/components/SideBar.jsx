...
import {faGlobe, faCircleUser, faUsers, faImage, faPalette, faUniversity} from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        ...
        { props.expanded &&
            <Nav className={"flex-column my-sidebar my-sidebar-expanded"}>
                ...
                <Nav.Item><Nav.Link as={Link} to="/samples"><FontAwesomeIcon icon={faImage} />Картины</Nav.Link></Nav.Item>
                <Nav.Item><Nav.Link as={Link} to="/museums"><FontAwesomeIcon icon={faUniversity} />Музеи</Nav.Link></Nav.Item>
                <Nav.Item><Nav.Link as={Link} to="/users/me"><FontAwesomeIcon icon={faCircleUser} />My account</Nav.Link></Nav.Item>
            </Nav>
        }
        { !props.expanded &&
            <Nav className={"flex-column my-sidebar my-sidebar-collapsed"}>
                ...
                <Nav.Item><Nav.Link as={Link} to="/samples"><FontAwesomeIcon icon={faImage} size="2x" /></Nav.Link></Nav.Item>
                <Nav.Item><Nav.Link as={Link} to="/museums"><FontAwesomeIcon icon={faUniversity} size="2x" /></Nav.Link></Nav.Item>
                <Nav.Item><Nav.Link as={Link} to="/users/me"><FontAwesomeIcon icon={faCircleUser} size="2x" /></Nav.Link></Nav.Item>
            </Nav>
        }
        </>
    )
